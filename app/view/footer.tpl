<div id="footer">
		...
		<ul id="footerelements">
			...
			<li><a href='<?= BASE_URL ?>/'>Home</a> | <a href='<?= BASE_URL ?>/working'>About Us</a> | <a href='<?= BASE_URL ?>/working'>Shipping & Returns</a> | <a href='<?= BASE_URL ?>/working'>Terms & Conditions</a> | <a onclick="loginAppear()"><u name = "log_in">Log in <u></a> </li>
		...
		<div id="myPopup" class="popup">
 			...
 			<div class="popup-content">
	  		    ...
	  		    <form  action="<?= BASE_URL ?>/footer/process" method="POST">
	  		    <h2>Log in:</h2>
				  Username:<br>
